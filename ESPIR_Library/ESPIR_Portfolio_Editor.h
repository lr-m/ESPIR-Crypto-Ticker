/*
  ESPIR_Portfolio_Editor.h - Portfolio editor interface for ST7735
...
#ifndef ESPIR_Portfolio_Editor_h
#define ESPIR_Portfolio_Editor_h
...
class ESPIR_Portfolio_Editor {
  // user-accessible "public" interface
public:
  ESPIR_Portfolio_Editor(Adafruit_ST7735 *, COIN *);
  char *press();
