...
char* ST7735_Keyboard::getCurrentInput(){
...
int ST7735_Keyboard::enterPressed(){
	return enter_pressed;
}

// Go to the bottom row of buttons
void ST7735_Keyboard::goToTabs(){
	if (mode != 4){
		last_mode = mode;
...
void ST7735_Keyboard::moveRight(){
	selected->display(mode);
